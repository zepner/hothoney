        ...
        <div id="standard" class="product">
          ...
          <div class="content">
            <ul>
              ...
              <li>Subscription Option</li>
              <li>Subscriber Email Series</li>
            </ul>
          </div>
        ...
        <div id="premium" class="product" style="background: url(assets/h9-img-10.jpg); background-repeat: no-repeat; background-size: cover; background-position-x: right;">
          ...
          <div class="content">
            <ul>
              <li>Branding</li>
              <li>Mailchimp Integration</li>
              <li>Website Services, Contact</li>
              <li>Subscription Sequence</li>
              <li>Premium Design</li>
              <li>Customized User Journey</li>
        ...
        <div id="deluxe" class="product">
          ...
          <div class="content">
            <ul>
              ...
              <li>Premium Design</li>
              <li>Customized User Journey</li>
              <li>2 Social Media Ads (Image + Copy)</li>
            </ul>
          </div>
          <button><a href="#contact">Speak to a Rep</a></button>
        </div>
      </div>
